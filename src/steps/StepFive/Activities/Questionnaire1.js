...
import { useQuestionaireOne } from './hooks';

const Questionnaire1 = () => {
  const { next, onChange, onSubmit, preguntas } = useQuestionaireOne();

  const questions2 = [
    'Se produce un defecto de software',
    'Se produce un bloqueo del sistema de origen conocido o desconocido',
    'Se produce un defecto de hardware',
    'Es ejecutado código malicioso (virus, trojanos, backdoors, worms)',
    'Se interrumpe el suministro de energía a los contenedores técnicos',
    'Se producen problemas con las telecomunicaciones',
    'Otros problemas de terceos o de los sistemas',
